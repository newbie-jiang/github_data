...
USERS = ["newbie-jiang", "LibDriver","zephyrproject-rtos","STMicroelectronics","espressif","Ameba-AIoT","stm32-hotspot","RT-Thread","openai","ARM-software","nrfconnect","google"]  # 在这里加你想展示的用户名
